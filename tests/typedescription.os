...
Процедура ТестДолжен_ПроверитьКвалификаторыДаты() Экспорт
	...
	юТест.ПроверитьРавенство  (К1, К3, "Квалификаторы с одинаковыми параметрами равны");
	юТест.ПроверитьНеРавенство(К1, К2, "Квалификаторы с разными параметрами не равны");
	юТест.ПроверитьНеРавенство(К1, К4, "Квалификаторы с разными параметрами не равны");

	юТест.ПроверитьРавенство(К1.ЧастиДаты, ЧастиДаты.ДатаВремя);
	юТест.ПроверитьРавенство(К2.ЧастиДаты, ЧастиДаты.Дата);
	юТест.ПроверитьРавенство(К3.ЧастиДаты, ЧастиДаты.ДатаВремя);
	юТест.ПроверитьРавенство(К4.ЧастиДаты, ЧастиДаты.Время);

	ОписаниеТипаДатаВремя = Новый ОписаниеТипов("Дата",,,,, Новый КвалификаторыДаты(ЧастиДаты.ДатаВремя)); 
	юТест.ПроверитьРавенство(ОписаниеТипаДатаВремя.КвалификаторыДаты.ЧастиДаты, ЧастиДаты.ДатаВремя);
